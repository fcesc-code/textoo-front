...
import { of } from 'rxjs';
describe('activities-global > components > mosaic > mosaicComponent', () => {
  const TITLE = 'test';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [MosaicComponent, GetLanguagePipe],
      providers: [
        {
  ...
  it(`${TITLE} 8 > method removeFilters should remove filters`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();
  ...
  it(`${TITLE} 9 > method loadActivities return activities`, () => {
    authService.setUser({
