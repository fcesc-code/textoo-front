...
import { of } from 'rxjs';
describe('group-sync > components > edit-games > activitiesPickerComponent', () => {
  const TITLE = 'test';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ActivitiesPickerComponent, GetLanguagePipe],
      providers: [
        {
  ...
  it(`${TITLE} 7 > method filterByAuthor filters data`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();

    component.filterByAuthor('ef4f0e28-86f8-4d2d-a56a-8b24d3286867');
    fixture.detectChanges();
    const FILTERED = component.filteredActivities.length;
    const UNFILTERED = component.activities$.length;
    expect(FILTERED).not.toEqual(UNFILTERED);
  ...
  it(`${TITLE} 8 > method filterById filters data`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();

    component.filterById('ae40070d-6edd-4e95-aab7-8ad5a02ebc8a');
    fixture.detectChanges();
    const FILTERED = component.filteredActivities.length;
    const UNFILTERED = component.activities$.length;
    expect(FILTERED).not.toEqual(UNFILTERED);
  ...
  it(`${TITLE} 9 > method retainId filters data`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();

    component.retainId('ae40070d-6edd-4e95-aab7-8ad5a02ebc8a', 'some title');
    fixture.detectChanges();
    const FILTERED = component.filteredActivities.length;
    const UNFILTERED = component.activities$.length;
    expect(FILTERED).not.toEqual(UNFILTERED);
  ...
  it(`${TITLE} 10 > method removeFilters should remove filters`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();
  ...
  it(`${TITLE} 11 > method loadActivities return activities`, () => {
    authService.setUser({
  ...
  it(`${TITLE} 12 > on parent component input data is filtered when ngOnChanges`, () => {
    component.activities$ = MOCK_ACTIVITIES;
    component.filteredActivities = MOCK_ACTIVITIES;
    fixture.detectChanges();

    component.selectedActivity = 'ae40070d-6edd-4e95-aab7-8ad5a02ebc8a';
